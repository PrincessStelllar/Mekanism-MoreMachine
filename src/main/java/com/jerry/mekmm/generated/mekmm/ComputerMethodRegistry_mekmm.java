...
public class ComputerMethodRegistry_mekmm implements IComputerMethodRegistry {
    ...
    public void register() {
        ...
        FactoryRegistry.register(TileEntityReplicatingFactory.class, TileEntityReplicatingFactory$ComputerHandler::new, TileEntityUpdateable.class, CapabilityTileEntity.class, TileEntityMekanism.class, TileEntityConfigurableMachine.class, TileEntityMoreMachineFactory.class, TileEntityItemToItemMoreMachineFactory.class);
        FactoryRegistry.register(TileEntityStampingFactory.class, TileEntityStampingFactory$ComputerHandler::new, TileEntityUpdateable.class, CapabilityTileEntity.class, TileEntityMekanism.class, TileEntityConfigurableMachine.class, TileEntityMoreMachineFactory.class, TileEntityItemToItemMoreMachineFactory.class);
